        ...
        <div class="app-navbar flex-shrink-0">
            ...
            <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                ...
                <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                    <img src="assets/media/img/profile/{{ $foto }}" alt="user" />
                </div>

                <span class="symbol-label font-size-sm text-dark p-4">{{ Auth::user()->nama_user }}</span>
                <!--begin::User account menu-->
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-semibold py-4 fs-6 w-300px" data-kt-menu="true">
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            <!--begin::Avatar-->
                            <div class="symbol symbol-50px me-5">
                                <img alt="Logo" src="assets/media/img/profile/{{ $foto }}" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Username-->
