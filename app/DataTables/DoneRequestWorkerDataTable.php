...
use App\Models\DoneRequestWorker;
...
class DoneRequestWorkerDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\DoneRequestWorker $model
    ...
    {
        return $this->builder()
            ->setTableId('donerequestworker-table')
    ...
    {
        return 'DoneRequestWorker_' . date('YmdHis');
    }
}
